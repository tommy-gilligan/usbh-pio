...
typedef enum {
  PIO_USB_PINOUT_DPDM = 16,  // DM = DP+1
  PIO_USB_PINOUT_DMDP = 17,  // DM = DP-1
} PIO_USB_PINOUT;
...
#define PIO_USB_DEFAULT_CONFIG                                             \
  {                                                                        \
    PIO_USB_DP_PIN_DEFAULT, PIO_SM_USB_TX_DEFAULT,     \
        PIO_USB_DMA_TX_DEFAULT, PIO_SM_USB_RX_DEFAULT, \
        PIO_SM_USB_EOP_DEFAULT, NULL, false, PIO_USB_PINOUT_DPDM \
  }
